...
<head>
    ...
    <style>
        ...
        transition: color 0.3s; /* Thêm hiệu ứng chuyển đổi màu trong 0.3 giây */
        }
        a:hover {
            color: yellow; /* Màu chữ khi di chuột vào là màu vàng */
        }
    </style>
</head>
<body>
    <?php if ($foundUser): ?>
        ...
        <table>
            <tr>
                ...
                <th>Ngày Sinh</th>
                <th>Địa Chỉ Email</th>
                <?php if (isset($foundUser['role']) && $foundUser['role'] == 'admin'): ?>
                    <th>Xem Thêm</th>
                <?php endif; ?>
            </tr>
            <tr>
